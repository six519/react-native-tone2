...
//
//  Modified by Ferdinand Silva on 8/21/19
...
void generateTone(double freq, int dur) {
    TGSineWaveToneGenerator *gen = [[TGSineWaveToneGenerator alloc] initWithChannels:1];
    gen->_channels[0].frequency = freq;
    gen->_channels[0].amplitude = SINE_WAVE_TONE_GENERATOR_AMPLITUDE_FULL;
    [gen playForDuration:dur];
}
